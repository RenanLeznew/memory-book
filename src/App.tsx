  ...
  return (
    <div className="bg-gradient-to-r from-orange-900 via-yellow-700 to-orange-900 brightness-50 w-screen h-screen border-8 border-[#321414]">
      ...
      <button 
        ...
        onMouseEnter={() => (setIsShown(true), setKeeper(1))}
        onMouseLeave={() => (setIsShown(false), setKeeper(0))}
      >
        <OurImage 
          source={source[index]}
          topbot="top-12"
      ...
      <button 
        className="cursor-default" 
        onMouseEnter={() => (setIsShown(true), setKeeper(2))}
        onMouseLeave={() => (setIsShown(false), setKeeper(0))}
      >
        <OurImage 
      ...
      <button 
        className="cursor-default" 
        onMouseEnter={() => (setIsShown(true), setKeeper(3))}
        onMouseLeave={() => (setIsShown(false), setKeeper(0))}
      >
        <OurImage 
      ...
      <button 
        className="cursor-default" 
        onMouseEnter={() => (setIsShown(true), setKeeper(4))}
        onMouseLeave={() => (setIsShown(false), setKeeper(0))}
      >
        <OurImage 
